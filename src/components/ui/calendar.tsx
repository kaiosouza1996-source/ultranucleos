  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        // rounded-md aqui evita o bug visual em que o dia de hoje/selecionado
        // (quadrado, do wrapper .cell) vazava atrás do círculo do dia
        // (rounded-md também, mas .day tem exatamente o mesmo tamanho h-9 w-9)
        // — as pontas do fundo rosa do .cell apareciam por fora do círculo azul.
